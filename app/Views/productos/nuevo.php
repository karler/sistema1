                        ...
                        <div class="card mb-4">
                        	...
                        	<div class="card-body">
                        		...
                        		<form method="post" action="<?=base_url()?>/public/Productos/guardar">
								  ...
								  <div class="form-group row">
									...
									<div class="col-8">
									  <input id="idunidad" name="idunidad" type="text" class="form-control">
									</div>
								  </div>
								  <div class="form-group row">
								  ...
								  <div class="form-group row">
									...
									<div class="col-8">
									  <div class="input-group">
										...
										<input id="precio_compras" name="precio_compra" type="text" class="form-control">
									  </div>
									</div>
								  </div>
								  <div class="form-group row">
									...
									<div class="col-8">
									  <input id="existencias" name="existencias" type="text" class="form-control">
									</div>
								  </div>
								  <div class="form-group row">
									<label for="stock_minimo" class="col-4 col-form-label">Stock mínimo</label> 
									<div class="col-8">
									  <input id="stock_minimo" name="stock_minimo" type="text" class="form-control">
									</div>
								  </div>
								  <div class="form-group row">
